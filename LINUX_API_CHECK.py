...
class GIT():
    ...
    def __init__(self):
        ...
        self.ID  = 'sangwoo.ahn'
        self.PW  = '@435tmdqls'
        self.url = '156.147.69.68'
        # self.basic_path = '//'+ self.url + '/work/hal-libs-header/hal_inc/'
        self.basic_path = '//' + self.url + '/work/linuxtv-ext-header/linux/alsa-ext/'
    ...
    def sshConnect(self):
        ...
        cmd_list = ['cd linuxtv-ext-header/linux/alsa-ext/', 'ls']
